...
LMTI is an independent local AI memory, safety, and skill-routing layer for AI
coding agents and software projects. The current architecture is built around a
